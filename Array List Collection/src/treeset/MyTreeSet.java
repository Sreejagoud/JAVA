package treeset;
	...
	public class MyTreeSet {
		...
		public static void main(String[] args) {
			...
			StudentTreeSet tob1=new StudentTreeSet(1, "Sreeja",540);
			StudentTreeSet tob2=new StudentTreeSet(2, "SSS",512);
			StudentTreeSet tob3=new StudentTreeSet(3, "Sree",500);
			ob.add(tob1);
			ob.add(tob2);
			ob.add(tob3);
			...
			StudentTreeSet tob4=new StudentTreeSet(1, "SREEJA",540);
			StudentTreeSet tob5=new StudentTreeSet(2, "SSS",512);
			StudentTreeSet tob6=new StudentTreeSet(3, "SREE",500);
			ob1.add(tob4);
			ob1.add(tob5);
			ob1.add(tob6);
			...
			StudentTreeSet tob7=new StudentTreeSet(1, "SREEJA",540);
			StudentTreeSet tob8=new StudentTreeSet(2, "SSS",512);
			StudentTreeSet tob9=new StudentTreeSet(3, "SREE",500);
			ob2.add(tob7);
			ob2.add(tob8);
			ob2.add(tob9);
