	...
	static Scanner sc=new Scanner(System.in);
		public static void addRecords() {
			try {
				...
				String selsql="select * from studentinfo where sid=?";
		...
		public static void updateRecords() {
			...
			try {
				...
				myconn=DbConnect.getConnection();
				String sel="select * from studentinfo where sid=?";
				...
				if(rs.next()) {
					...
					case 1:System.out.println("Enter the name to change");
					        String n=sc.next();
					        String cn="update studentinfo set sname=? where sid=?";
			        ...
			        String c=sc.next();
			        String csql="update studentinfo set scourse=? where sid=?";
			     ...
			     break;
					...
					String cnchange="update studentinfo set sname=?, scourse=? where sid=?";
